...
- The AnimationController can be accessed by clicking ZepetoAnimatorV2 (or ZepetoAnimator) that can be found at ZepetoPlayers GameObject > Player (in the inspector) > Motion Controller > Animation Controller.
