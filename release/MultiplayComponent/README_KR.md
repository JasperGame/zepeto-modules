...
<font style="color:red"> 주의사항 : 기존 작성했던 World.multiplay가 있다면, 서버코드(index.ts)와 스키마(schmas)가 덮어쓰기 되니 다른 폴더로 꼭 백업해두세요. </font>
...
<font style="color:red"> 주의사항 : Zeoeti Multiplay Component / Scene / DemoMovingBlock.unity  예제씬을 정상적으로 실행하려면 추가로 ZEPETO.Buildit.Loader 패키지를 임포트 해야합니다. </font>
