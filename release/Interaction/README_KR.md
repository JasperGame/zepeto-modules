...
3. IconButton 인스펙터의 Image > Source Image를 클릭하여 원하는 이미지로 교체합니다. (Resources/WorldEventIcons/Textures에 다양한 기본 아이콘이 있습니다.)
...
2. 우측의 GestureInteraction 스크립트의 Animation Clip을 원하는 애니메이션 클립으로 교체하여 주세요.   
    ...
    > 원하는 애니메이션을 추가할 수 있습니다.
        a. 제페토 공식 애니메이션 파일 가져오기 [[가이드]](https://docs.zepeto.me/studio-world/lang-ko/docs/animation_faq)
        b. Mixamo에서 원하는 커스텀 애니메이션 가져오기 [[가이드]](https://docs.zepeto.me/studio-world/lang-ko/docs/custom_animation)
...
2. 인터렉션 시 사용하는 애니메이션 파일을 Assets/Resources 폴더에 추가하여 주세요.   
 ...
 3. 씬에 배치한 ZepetoPlayersManager의 Get Animation Clip From Resources를 체크하면 제스쳐가 동기화 됩니다.   
    <img width="400" alt="image" src="./Image/GuideImage6.png">  
